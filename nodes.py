...
def sample_euler_a2(
    ...
    method:              integration order of the deterministic down-step:
                         ...
                         rk3 (3 evals), rk4 (4 evals) per substep.
...
class EulerA2Sampler:
    ...
    DESCRIPTION = (
        ...
        "substepping, practical substep scheduling, and EDM/flow parameterization support "
        "for smoother, more efficient ancestral sampling."
    )
